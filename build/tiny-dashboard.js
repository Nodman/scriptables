...
function createWidget({
  ...
  listWidget.backgroundGradient = gradient; // HEADER
  ...
  if (subValue) {
    ...
    const subValueText = subValueStack.addText(subValue); // hack to proper align text
  ...
  listWidget.addSpacer(GAP / 2); // GRAPH
